...
from app.models.incident_event import IncidentCreatedEvent, IncidentUpdatedEvent
...
async def process_message(
    ...
    if topic == "incident.created":
        ...
        await classify_incident(
            event.incident_id, event.title, event.description
        )
...
async def classify_incident(
    incident_id: object, title: str, description: str
